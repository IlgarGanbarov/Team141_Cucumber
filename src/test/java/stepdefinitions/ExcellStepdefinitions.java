...
public class ExcellStepdefinitions {
    Sheet sayfa1;
    ...
    public void baskenti_jakarta_olan_ulkenin_tum_bilgilerini_yazdirir() {
        ulkelerMapi.keySet();
        ulkelerMapi.values();
        ulkelerMapi.entrySet();
        //System.out.println(ulkelerMapi.containsValue("Jakarta"));
